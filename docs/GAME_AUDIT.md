...
| Duplicate command live regions | Latest command appeared in two simultaneous status regions | Keep the visible Activity Center entry and a single existing command announcement |
