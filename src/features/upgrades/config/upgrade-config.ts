...
export const DETAILING_LINE: UpgradeDefinition = Object.freeze({
  ...
  requirements: Object.freeze<Requirement[]>([{ type: 'business-level', businessId: STARTER_BUSINESS.id, minimumLevel: 5 }]),
...
export const FLEET_LOGISTICS: UpgradeDefinition = Object.freeze({
  ...
  purchaseCost: moneyFromMinorUnits('1500000'), requirements: Object.freeze<Requirement[]>([{ type: 'any-business-owned' },
    { type: 'upgrade-purchased', upgradeId: PRESSURE_WASHER.id }, { type: 'player-level', minimumLevel: 5 }]),
...
export const STREET_CONNECTIONS: UpgradeDefinition = Object.freeze({
  ...
  purchaseCost: moneyFromMinorUnits('75000'), requirements: Object.freeze<Requirement[]>([{ type: 'player-level', minimumLevel: 2 }]),
...
export const EXPRESS_TIPS: UpgradeDefinition = Object.freeze({
  ...
  purchaseCost: moneyFromMinorUnits('40000'), requirements: Object.freeze([]),
