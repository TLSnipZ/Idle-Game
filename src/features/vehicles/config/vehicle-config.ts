...
export const TOSEKI_RENDAN: VehicleDefinition = Object.freeze({
  id: 'vehicle:toseki-rendan', name: 'Toseki Rendan', manufacturer: 'Toseki', model: 'Rendan', category: 'All-weather delivery operator',
  description: 'Four doors, one very organized delivery operation. The wing is not tax deductible. Probably.',
  purchaseCost: moneyFromMinorUnits('11500000'),
  requirements: Object.freeze<Requirement[]>([
    { type: 'player-level', minimumLevel: 12 },
    { type: 'business-owned', businessId: 'business:afterdark-customs' },
    { type: 'business-level', businessId: 'business:afterdark-customs', minimumLevel: 3 },
  ]),
  modifiers: Object.freeze<Modifier[]>([
    Object.freeze({
      id: 'modifier:toseki-rendan-delivery-cash', sourceId: 'vehicle:toseki-rendan',
      target: Object.freeze({ stat: 'job-reward' }),
      operation: 'multiply-basis-points', bonusBasisPoints: 1800,
    }),
  ]),
});
export const SEVRIN_CANTO_CLUB: VehicleDefinition = Object.freeze({
  id: 'vehicle:sevrin-canto-club', name: 'Sevrin Canto Club', manufacturer: 'Sevrin', model: 'Canto Club', category: 'Executive logistics coupe',
  description: 'A discreet performance coupe for an empire that earns while you park. The invoices have excellent road manners.',
  purchaseCost: moneyFromMinorUnits('16500000'),
  requirements: Object.freeze<Requirement[]>([
    { type: 'player-level', minimumLevel: 14 },
    { type: 'business-owned', businessId: 'business:afterdark-customs' },
    { type: 'business-level', businessId: 'business:afterdark-customs', minimumLevel: 5 },
  ]),
  modifiers: Object.freeze<Modifier[]>([
    Object.freeze({
      id: 'modifier:sevrin-canto-club-production', sourceId: 'vehicle:sevrin-canto-club',
      target: Object.freeze({ stat: 'business-production', businessId: null }),
      operation: 'multiply-basis-points', bonusBasisPoints: 1800,
    }),
    Object.freeze({
      id: 'modifier:sevrin-canto-club-dispatcher-cash', sourceId: 'vehicle:sevrin-canto-club',
      target: Object.freeze({ stat: 'job-reward', context: 'dispatcher' }),
      operation: 'multiply-basis-points', bonusBasisPoints: 1200,
    }),
  ]),
});
