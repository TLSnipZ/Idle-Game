import { isVehicleAppearances } from '../config/appearance-config';
...
export function assertGarageState(garage: GarageState): void {
  ...
  if (Object.hasOwn(garage, 'appearances') && !isVehicleAppearances(garage.appearances, garage.ownedVehicleIds))
    throw new RangeError('Invalid authoritative vehicle appearance');
