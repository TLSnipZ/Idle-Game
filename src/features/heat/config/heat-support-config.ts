...
export const HEAT_SUPPORT_RULES: readonly HeatSupportRule[] = Object.freeze([
  Object.freeze({ kind: 'local-business', districtId: 'territory:waterfront', minimumLevel: 10,
    modifier: Object.freeze({ id: 'modifier:decoy-dockside', sourceId: 'business:dockside-detail',
      target: Object.freeze({ stat: 'heat-response-cost' }), operation: 'multiply-basis-points', bonusBasisPoints: -2000 }) }),
  Object.freeze({ kind: 'local-business', districtId: 'territory:neon-mile', minimumLevel: 10,
    modifier: Object.freeze({ id: 'modifier:decoy-laundry', sourceId: 'business:neon-laundry',
      target: Object.freeze({ stat: 'heat-response-cost' }), operation: 'multiply-basis-points', bonusBasisPoints: -2000 }) }),
  Object.freeze({ kind: 'assigned-crew',
    modifier: Object.freeze({ id: 'modifier:decoy-mara', sourceId: 'crew:mara-knox',
