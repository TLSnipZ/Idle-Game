...
export function stringifySaveFixture(value: unknown): string {
  ...
  if (typeof version !== 'number' || version < 4 || version >= 16
  ...
  const historicalGarage = version >= 6 && Array.isArray(ids) ? {
  ...
  if (version < 15 && typeof automation === 'object' && automation !== null && !Array.isArray(automation)) {
