...
export function territoryState(owned = false, playerLevel = 12, businessLevel = 15): GameState {
  ...
  return { ...fresh, economy: { cash: moneyFromMinorUnits('10000000') },
    ...
    automation: { businessAutoUpgradeTargetId: 'business:dockside-detail', enabledIds: [], businessAutoUpgradeElapsedMs: 0, unlockedIds: [DELIVERY_DISPATCHER.id], starterJobElapsedMs: 0 },
