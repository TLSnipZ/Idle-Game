import { MAX_HEAT, requireHeatState, RISKY_DELIVERY_HEAT, RISKY_DELIVERY_HEAT_LIMIT } from '../features/heat';
...
export function selectRiskyDelivery(state: GameState) {
  ...
  return { reward, tooHot, canRun: !tooHot && reward.ok, heatGain: RISKY_DELIVERY_HEAT,
