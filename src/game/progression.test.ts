...
function owned(xp = 0) {
  ...
  return { ...state, progression: { xp }, economy: { cash: moneyFromMinorUnits('100000000') },
    ...
    automation: { businessAutoUpgradeTargetId: 'business:dockside-detail' as const, enabledIds: [], businessAutoUpgradeElapsedMs: 0, unlockedIds: [D.id], starterJobElapsedMs: 0 } };
}
...
describe('three atomic XP sources', () => {
  ...
  it('level upgrades award 25 each and purchases award none', () => {
    ...
    const locked = { ...state, automation: { businessAutoUpgradeTargetId: 'business:dockside-detail' as const, enabledIds: [], businessAutoUpgradeElapsedMs: 0, unlockedIds: [], starterJobElapsedMs: 0 } };
  ...
  it('offline cycles share the cap and retain prior progress; business-only income earns no XP', () => {
    const state = { ...owned(), automation: { businessAutoUpgradeTargetId: 'business:dockside-detail' as const, enabledIds: [], businessAutoUpgradeElapsedMs: 0, unlockedIds: [D.id], starterJobElapsedMs: 5000 },
    ...
    const locked = { ...owned(), automation: { businessAutoUpgradeTargetId: 'business:dockside-detail' as const, enabledIds: [], businessAutoUpgradeElapsedMs: 0, unlockedIds: [], starterJobElapsedMs: 0 } };
