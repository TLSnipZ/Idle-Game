...
idle/tycoon browser game. **Phase 7A: Solara City territory foundation.**
...
grandfathered ownership and fresh-save progression live. Phase 5C and Phase 6A were also manually verified live by the user. Phase 6B was manually verified live by the user; Phase 7A live verification remains pending.
...
vehicles and permanent skills remain. Older saves gain Waterfront only. Heat, Crew,
Random Events and a full city map are not implemented.
