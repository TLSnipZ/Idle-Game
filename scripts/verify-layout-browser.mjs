...
const targets = [[], ['starter-heading', 'businesses-heading', 'upgrades-heading', 'automation-heading'], ['city-heading', 'crew-heading', 'city-events-heading'], ['garage-heading', 'tuning-heading'], ['rebirth-heading', 'skill-tree-heading', 'achievements-heading', 'statistics-heading', 'save-transfer-heading']];
const results = [];
let browser;
